/* @ts-self-types="./bcu_api.d.ts" */

export class BCUEngine {
    static __wrap(ptr) {
        const obj = Object.create(BCUEngine.prototype);
        obj.__wbg_ptr = ptr;
        BCUEngineFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        BCUEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    dispatch_editor_command(json_str) {
        ...
        const ret = wasm.bcuengine_dispatch_editor_command(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    export_imgcut(id) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.bcuengine_export_imgcut(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    export_maanim(id) {
        ...
        try {
            const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.bcuengine_export_maanim(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    export_mamodel(id) {
        ...
        try {
            const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.bcuengine_export_mamodel(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {any}
     */
    get_animation_state(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.bcuengine_get_animation_state(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
     ...
     * @returns {any}
     */
    get_part_transform(id, part_idx) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.bcuengine_get_part_transform(this.__wbg_ptr, ptr0, len0, part_idx);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {Promise<BCUEngine>}
     */
    static init(canvas) {
        const ret = wasm.bcuengine_init(canvas);
        return ret;
    }
    /**
     * @param {string} id
     ...
     */
    list_animations() {
        const ret = wasm.bcuengine_list_animations(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @param {string} maanim_txt
     */
    load_animation(id, imgcut_txt, mamodel_txt, maanim_txt) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(imgcut_txt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(mamodel_txt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(maanim_txt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.bcuengine_load_animation(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    load_sprite(id, bytes) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.bcuengine_load_sprite(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} alpha
     */
    render(id, sprite_id, off_x, off_y, alpha) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(sprite_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.bcuengine_render(this.__wbg_ptr, ptr0, len0, ptr1, len1, off_x, off_y, alpha);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    resize(width, height) {
        wasm.bcuengine_resize(this.__wbg_ptr, width, height);
    }
    /**
     * @param {string} id
     * @param {number} frame
    ...
    set_frame(id, frame) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.bcuengine_set_frame(this.__wbg_ptr, ptr0, len0, frame);
    }
    /**
     * @param {string} id
     */
    tick(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.bcuengine_tick(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} id
     */
    update(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.bcuengine_update(this.__wbg_ptr, ptr0, len0);
    }
}
if (Symbol.dispose) BCUEngine.prototype[Symbol.dispose] = BCUEngine.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_bcuengine_new: function(arg0) {
            const ret = BCUEngine.__wrap(arg0);
            return ret;
        },
        ...
        __wbg_new_typed_bf31d18f92484486: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___js_sys_42eb24622174c897___Function_fn_wasm_bindgen_2474f29060f80a46___JsValue_____wasm_bindgen_2474f29060f80a46___sys__Undefined___js_sys_42eb24622174c897___Function_fn_wasm_bindgen_2474f29060f80a46___JsValue_____wasm_bindgen_2474f29060f80a46___sys__Undefined_______true_(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue__core_9b3796e30d99ddb7___result__Result_____wasm_bindgen_2474f29060f80a46___JsError___true_);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue______true_);
            return ret;
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue______true__2);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./bcu_api_bg.js": import0,
    };
}

function wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue______true_(arg0, arg1, arg2) {
    wasm.wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue______true_(arg0, arg1, arg2);
}

function wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue______true__2(arg0, arg1, arg2) {
    wasm.wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue______true__2(arg0, arg1, arg2);
}

function wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue__core_9b3796e30d99ddb7___result__Result_____wasm_bindgen_2474f29060f80a46___JsError___true_(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___wasm_bindgen_2474f29060f80a46___JsValue__core_9b3796e30d99ddb7___result__Result_____wasm_bindgen_2474f29060f80a46___JsError___true_(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___js_sys_42eb24622174c897___Function_fn_wasm_bindgen_2474f29060f80a46___JsValue_____wasm_bindgen_2474f29060f80a46___sys__Undefined___js_sys_42eb24622174c897___Function_fn_wasm_bindgen_2474f29060f80a46___JsValue_____wasm_bindgen_2474f29060f80a46___sys__Undefined_______true_(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_2474f29060f80a46___convert__closures_____invoke___js_sys_42eb24622174c897___Function_fn_wasm_bindgen_2474f29060f80a46___JsValue_____wasm_bindgen_2474f29060f80a46___sys__Undefined___js_sys_42eb24622174c897___Function_fn_wasm_bindgen_2474f29060f80a46___JsValue_____wasm_bindgen_2474f29060f80a46___sys__Undefined_______true_(arg0, arg1, arg2, arg3);
}
...
const BCUEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_bcuengine_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bcu_api_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
