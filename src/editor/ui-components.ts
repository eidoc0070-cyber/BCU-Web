...
export class UIManager {
  ...
  private projectNameInput = document.getElementById(
    'input-project-name',
  ) as HTMLInputElement;
  ...
  constructor(private stateManager: EditorStateManager) {
    ...
    this.partsTreeBoundary = new UIErrorBoundary(
      ...
      'PartsTree',
      () => {
        this.partsTreeBoundary.clearError();
        this.lastPartsJson = '';
      },
    );
    this.imgcutListBoundary = new UIErrorBoundary(
      ...
      'ImgCutList',
      () => {
        this.imgcutListBoundary.clearError();
        this.lastImgCutJson = '';
      },
    );
    this.fileExplorerBoundary = new UIErrorBoundary(
      ...
      'FileExplorer',
      () => {
        this.fileExplorerBoundary.clearError();
        this.lastFilesJson = '';
      },
    );
    ...
    this.projectNameInput?.addEventListener('input', () => {
      eventBus.emit('PROJECT_NAME_CHANGED', {
